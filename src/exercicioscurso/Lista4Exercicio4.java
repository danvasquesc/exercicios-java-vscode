        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            for (i = 0; i < N; i++) {
                ...
                if (denominador == 0) {
                    ...
                    /*casting // aqui alterei o momento que ocorre a divisão, eu tinha colocado antes do {
                    if, mas para processar somente se for para o else e poupar processamento, troquei de lugar */
